...
import { getIdToken, getAuth, signInAnonymously, onAuthStateChanged } from "firebase/auth";
...
export { app, storage, analytics, ref, uploadBytesResumable, getDownloadURL, getIdToken, onMessage, getAuth, signInAnonymously, onAuthStateChanged };
